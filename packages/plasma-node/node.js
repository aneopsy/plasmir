...
program
  ...
  .option(
    '-o, --operator <endpoint>',
    'Endpoint of the operator to connect to.',
    'http://107.22.13.89/api'
  )
  .option(
    '-e, --ethereum <endpoint>',
    'Endpoint of the Ethereum node to connect to.',
    'https://ropsten.infura.io/v3/fce31f1fb2d54caa9b31ed7d28437fa5'
  )
...
const options = {
  ...
  dbPath: dbPath,
  debug: 'service:*',
  contractProvider: PlasmaCore.providers.ContractProvider.HttpContractProvider,
  walletProvider: PlasmaCore.providers.WalletProviders.LocalWalletProvider,
  operatorProvider: PlasmaCore.providers.OperatorProvider.HttpOperatorProvider,
